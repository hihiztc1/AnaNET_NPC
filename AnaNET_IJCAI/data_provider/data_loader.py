...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, flag='pred', size=None,
                 features='S', data_path='htk1_YC0013_h1_pre.csv',
    ...
    def __read_data__(self):
        ...
        df_test = df_raw['date'][border1:border2]
...
class D0_Dataset_Pred(Dataset):
    ...
    def __read_data__(self):
        ...
        border1 = len(df_raw) - (self.seq_len * 3)
        border2 = len(df_raw)
